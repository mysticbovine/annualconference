...
<body class=" bg-yellow faded">
    ...
    <div class="container body ed-session">
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p class="lead">Here is a list of the Friday Fun Events as of February 21, 2020. More details will be
                    published here as the come available or are updated.</p>
            </div>
        </div>
        ...
        <div class="row ed-session-bios">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="ed-speakers">
                        <div class="committee leader ">
                            <a data-toggle="modal" data-target="#mai">
                                <div class="img-circle center-block grow">
                                    <span class="field-content">
                                        <img alt="Mai Paredes" class="img-responsive" height="200"
                                            src="images/speakers/mai.jpg" typeof="Image" width="200">
                                    </span>
                                </div>
                        ...
                        <div class="committee leader ">
                            <a data-toggle="modal" data-target="#arthur">
                                <div class="img-circle center-block grow">
                                    <span class="field-content">
                                        <img alt="Arthur Gee" class="img-responsive" height="200"
                                            src="images/speakers/arthur.jpg" typeof="Image" width="200">
                                    </span>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="winstonLabel">Friday Night Speakers</h4>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="tomLabel">Friday Night Speakers</h4>
                </div>
                <div class="modal-body bg-yellow faded bio">
                    <h3 class="text-center">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="michelleLabel">Friday Night Dancers</h4>
                </div>
                <div class="modal-body bg-yellow faded bio">
                    <h3 class="text-center">
                        MPower Your Inner Ninja <br>
    ...
    <!-- mai -->
    <div class="modal fade" id="mai" tabindex="-1" role="dialog" aria-labelledby="maiLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="maiLabel">Friday Night Dancers</h4>
                </div>
                <div class="modal-body bg-yellow faded bio">
                    <h3 class="text-center">
                        Flamenco <br>
                    ...
                    <p class="lead">Like a true flamenco gypsy, Mai has lived in different places to pursue
                        things that her heart dictates. </p>
                    <p>Mai was born, raised, and educated in the Philippines. Like a true flamenco gypsy,
                        she has lived in different places to pursue things that her heart dictates. </p>
                    <p>Mai started her love affair with flamenco dancing when she went through a very
                        ...
                        sharing the stage with them someday</p>
                    <p>Mai works in the competitive financial industry and finds that life can sometimes be
    ...
    <!-- arthur -->
    <div class="modal fade" id="arthur" tabindex="-1" role="dialog" aria-labelledby="arthurLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="arthurLabel">Friday Night Dancers</h4>
                </div>
                <div class="modal-body bg-yellow faded bio">
                    <h3 class="text-center">
                    Arthur with Mai & Kyriaki<br>
                    ...
                    <p>Arthur has been a Toastmaster since 1991. He has invited many guests to speak at his
                        club, Seymour Speakers--from Peter Legge (an entrepreneur and philanthropist) to
                        Olga Katelco (a 94-year-old athlete who ran and threw the discus 13 meters).</p>
                    <p>At 59, Arthur started running and formed a Seymour Speakers Vancouver Sun Run team.
                    </p>
                    <p>He has now changed his focus to Track & Field. In 2010, when the World Indoor Meet
                        ...
                        2010 World Indoor Masters Athletic Championships.</p>
                    <p>Arthur has always loved to dance. In high school, he spent a lot of time at the
                        Arthur Murray dance studio.</p>

                    <p>For more information about Aurther's Toastmasters club visit <a
                            href="http://vancouvertoastmasters.com/" target="_blank"
                            rel="noopener noreferrer">vancouvertoastmasters.com</a></p>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="kyriaki" tabindex="-1" role="dialog" aria-labelledby="kyriakiLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="kyriakiLabel">Friday Night Dancers</h4>
                </div>
                <div class="modal-body bg-yellow faded bio">
                    <h3 class="text-center">
                    Belly Dancing <br>
                    ...
                    <p>Kyriaki was born and raised in Greece. Belly dancing is part of her Mediterranean heritage. From
                        ...
                        participated and performed in Egypt’s biggest belly dance festival, the Ahla wa Sahla.</p>
                    <p>For more information about Kyriaki's Toastmasters club visit <a
                            href="http://vancouvertoastmasters.com/" target="_blank"
                            rel="noopener noreferrer">vancouvertoastmasters.com</a></p>
                </div>
                <div class="modal-footer">
