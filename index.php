        ...
        <div class="col-sm-10 col-sm-offset-1 text-center">
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
              <img src="images/logo-b.png" class="img-responsive center-block">
            </div>
          </div>
          ...
          <p class="">
            <a href="https://www.facebook.com/events/387474351939561/" target=_blank>
    ...
    <div class="container ">
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
          ...
          <p class="lead hanging-indent"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> International Speech Contest (the winner goes on to compete at the World level!)</p>
          ...
          <p class="lead hanging-indent"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Inspiring keynotes (speakers to be confirmed)</p>
          <p class="lead hanging-indent"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Candidates showcase</p>
