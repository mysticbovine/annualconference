...
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
     <title>Submitted | Communication & Leadership Award Nomination | Annual Conference | District 96 Toastmasters</title>
  ...
  <div id="main-content" class="bg-yellow faded container-full padding50">
    <div class="container body">
      <div class="col-sm-12  text-center">
        ...
        <h3 class="lead">Thank you! Your nomination has been sent.</h3>		
